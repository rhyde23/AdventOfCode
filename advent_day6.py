...
def part_one() :
    questions = [''.join(question.split('\n')) for question in questions.split('\n\n')]
    return sum([len(list(set(question))) for question in questions])

def part_two(questions) :
    questions = [[list(set(element)) for element in question.split('\n')] for question in questions.split('\n\n')]
    count = 0
