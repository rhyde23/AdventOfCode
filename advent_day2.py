...
def part_one() :
    ...
    for line in all_lines :
        ...
        letter = requirement[-1]
        minimum, maximum = requirement[:-1].split('-')
...
def part_two() :
    ...
    for line in all_lines :
        requirement, password = line.split(':')
        letter = requirement[-1]
        place1, place2 = requirement[:-1].split('-')
        place1, place2 = int(place1)-1, int(place2)-1
        if (password[place1] == letter and password[place2] != letter) or (password[place2] == letter and password[place1] != letter) :
            count += 1
    return count
